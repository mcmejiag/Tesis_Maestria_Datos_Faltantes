...
prop_missingage <- 0.40
prop_missingintubation <- 0.40 
prop_missingsaps3 <- 0.40 
prop_missingsao <- 0.40   
prop_missingicu <- 0.40  
prop_missingestado <- 0.40  
prop_missingsex <- 0.40
prop_missingsystolic <- 0.40  
prop_missingdiastolic <- 0.40 
...
legend("bottomright", legend = c(
       ...
       col = c( "#d35967", "#0072B2", "#009E73"), lwd = 2, cex = 0.8)
