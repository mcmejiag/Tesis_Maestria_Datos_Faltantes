...
setwd("/Users/ycd455/Desktop/University Camila 2025/Tesis Maestria 2025/Codes Final/Codes Final Cross Validation")
...
prop_missingage <- 0.20
prop_missingintubation <- 0.20 
prop_missingsaps3 <- 0.20 
prop_missingsao <- 0.20   
prop_missingicu <- 0.20  
prop_missingestado <- 0.20  
prop_missingsex <- 0.20
prop_missingsystolic <- 0.20  
prop_missingdiastolic <- 0.20 
...
Ensayocovid2$sex[sample(nrow(Ensayocovid2), prop_missingsex * nrow(Ensayocovid2))] <- NA
